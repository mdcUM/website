...
export const CLIENTS = [
  {
    ...
    work: [
      'Designed hypothetical survey questions',
      'NLP framework for student prompts',
      'Developed personas for AI users',
    ],
    impact: [{ label: 'User Personas Developed', value: '3+' }, { label: 'Data Collection Frameworks', value: '1' }],
    testimonial: null,
    website: 'https://www.a2schools.org/',
    caseUrl: '/work/aaps',
    description: 'AAPS is investigating AI literacy among secondary-level students to understand how they use AI as a thinking partner and learning tool.',
    whatwedid: 'We designed hypothetical survey questions to gather baseline data on student AI use without penalizing them for their answers. We established frameworks to process student prompts using NLP techniques and analyzed how AI use is split across quantitative and qualitative subjects. We analyzed the data to develop personas for different types of AI users.',
  },
  {
    name: 'Michigan Advocacy Program',
    slug: 'map',
    logo: '/clients/map_logo.webp',
    ...
    work: [
      'Cleaned case data with Python and Pandas',
      'Calculated precise case durations',
      'Statistical hypothesis testing',
    ],
    impact: [{ label: 'Faster Resolution Time', value: '28%' }, { label: 'Client Fall-off Decrease', value: '11.8%' }],
    testimonial: null,
    website: 'https://miadvocacy.org/',
    caseUrl: '/work/map',
    description: 'The Michigan Advocacy Program’s Legal Navigator Program aims to reduce delays and client disengagement in the expungement process.',
    whatwedid: 'We analyzed the impact of the Legal Navigator Program on case efficiency and client fall-off. Using Python and Pandas, we cleaned case data and converted dates to calculate precise case durations. We utilized statistical hypothesis testing to determine the relationship between program involvement and the duration of case completion.',
  },
  {
    ...
    impact: [{ label: 'Automated Pipeline', value: '100%' }, { label: 'Ranking Metrics Computed', value: '10+' }],
    testimonial: null,
    website: 'https://mcfn.org/',
    caseUrl: '/work/mcfn-w26',
    description: 'The Michigan Campaign Finance Network project uses publicly available contribution data from the Michigan Bureau of Elections to support PAC-level financial transparency.',
    whatwedid: 'We built an automated backend data pipeline to programmatically fetch, clean, and normalize raw campaign finance data. We computed ranking metrics such as total dollars raised and the number of contributions at the PAC level. We developed an interactive frontend dashboard with dynamic sorting and time-based filters.',
  },
  {
    ...
    work: [
      'Improved agent decision-making and reasoning',
      'Introduced multiple agents with differentiated traits',
    ],
  ...
  },
  {
    name: 'U-M SMTD',
    slug: 'um-smtd',
    logo: '/clients/univ_michigan.webp',
    brand: 'rgba(25, 123, 255, 1)',
    year: 2026,
    semester: 'Winter 2026',
    ...
    work: [
      'Cleaned 180,000+ data points',
      'Analyzed student retention and engagement trends',
      'Calculated lift probabilities for engagement',
    ],
    impact: [{ label: 'Increased career matching probability', value: '16%-24%' }, { label: 'Data points analyzed', value: '180,000+' }],
    testimonial: null,
    website: 'https://smtd.umich.edu/',
    caseUrl: '/work/um-smtd',
    description: 'The EXCEL Lab within the School of Music, Theatre & Dance sets arts students up with career advice, mentorship, and coaching.',
    whatwedid: 'We cleaned an inherited dataset of over 180,000 data points to analyze student engagement. We investigated trends in student retention and engagement across different majors and grade levels. We tracked student involvement against career potential and calculated lift probabilities to map the likelihood of future engagement.',
  },
  {
    name: 'U-M Tauber Institute',
    slug: 'um-tauber',
    logo: '/clients/map.webp',
    brand: 'rgba(25, 123, 255, 1)',
    year: 2026,
    semester: 'Winter 2026',
    serviceArea: 'Analytics',
    ...
    impact: [{ label: 'Analysis Time Reduced', value: '95%' }, { label: 'Feedback to Insights', value: '< 5s' }],
    testimonial: null,
    website: 'https://tauber.umich.edu/',
    caseUrl: '/work/um-tauber',
    description: 'The Tauber Institute collects end-of-cycle survey data across students, faculty advisors, and project sponsors.',
    whatwedid: 'We built a data processing pipeline that cleans, merges, and organizes survey responses from multiple stakeholder groups into a unified, structured dataset. We designed an interactive dashboard that provides a centralized view of all projects and survey responses with dynamic filtering. We implemented an AI-generated summary feature that automatically analyzes responses into plain language summaries of themes, strengths, and concerns.',
  },
  {
    name: 'Stanhope Research & Strategy',
    slug: 'stanhope',
