    ...
    <main className="relative min-h-dvh bg-[#0f1021] text-white overflow-hidden">
      ...
      <section className="relative z-10 mx-auto max-w-6xl px-4 py-14 md:py-20">
        <header className="mb-10 md:mb-12">
          ...
          <p className="mt-3 max-w-2xl text-white/80">This section will be updated soon. If you want to work with us, please email us at <a href="mailto:mdc-eboard@umich.edu" className="text-blue-500 underline">mdc-eboard@umich.edu</a></p>
